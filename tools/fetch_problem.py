#!/usr/bin/env python3
"""Fetch a LeetCode problem and generate a JavaScript stub plus a node:test file.
...
def render_test(problem: Problem, solution_file: str, test_file: str) -> str:
    ...
    lines = [
        ...
        "//",
        f"// Run:  node --test --watch leetcode/{test_file}",
        "",
...
def main() -> int:
    ...
    print(f"\nRun:  node --test --watch {out / test_file}")
    return 0
